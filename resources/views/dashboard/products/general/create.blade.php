                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>  {{__('admin/product.data')}}  </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.productName')}}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/product.like')}}
                                                            </label>
                                                            <input type="text"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.sortDescription')}}
                                                            </label>
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.selectSection')}}
                                                            </label>
                                                            <select name="categories[]" class="select2 form-control" multiple>
                                                                <optgroup label=" {{__('admin/product.pleaseSelect')}}">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.selectTag')}}
                                                            </label>
                                                            <select name="tags" class="select2 form-control" multiple>
                                                                <optgroup label="{{__('admin/product.pleaseSelectTag')}} ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.selectBrand')}}
                                                            </label>
                                                            <select name="brand_id" class="select2 form-control">
                                                                <optgroup label="{{__('admin/product.pleaseSelectBrand')}}">
