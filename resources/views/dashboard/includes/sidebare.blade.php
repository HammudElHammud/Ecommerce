...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="#"><i class="la la-list"></i><span class="menu-title" data-i18n="nav.dash.main">{{__('admin/main.main sections')}}</span><span class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Category::parent()->count()}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{url('admin/main_categories')}}" data-i18n="nav.dash.ecommerce">{{__('admin/main.all sections')}}</a>
                    </li>
                    <li class="active"><a class="menu-item" href="{{url('/admin/main_categories/create')}}" data-i18n="nav.dash.crypto">{{__('admin/main.addNowSection')}}</a>
                    </li>
                    <li><a class="menu-item" href="dashboard-sales.html" data-i18n="nav.dash.sales">Sales</a>
                    </li>
                </ul>
            </li>
{{--            <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">{{__('admin/main.sub sections')}}</span><span class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Category::Child()->count()}}</span></a>--}}
{{--                <ul class="menu-content">--}}
{{--                    <li><a class="menu-item" href="{{url('admin/Sub_categories')}}" data-i18n="nav.dash.ecommerce">{{__('admin/main.sub all sections')}}</a>--}}
{{--                    </li>--}}
{{--                    <li class="active"><a class="menu-item" href="{{url('/admin/Sub_categories/create')}}" data-i18n="nav.dash.crypto">{{__('admin/main.addSubSection')}}</a>--}}
{{--                    </li>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
            <li class=" nav-item"><a href=""><i class="la la-500px   "></i><span class="menu-title" data-i18n="nav.dash.main">{{__('admin/bands.band')}}</span><span class="badge badge badge-info badge-pill float-right mr-2"></span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href=""><i class="la la-tags"></i><span class="menu-title" data-i18n="nav.dash.main">{{__('admin/tags.tag')}}</span><span class="badge badge badge-info badge-pill float-right mr-2"></span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href=""><i class="la la-tags"></i><span class="menu-title" data-i18n="nav.dash.main">{{__('admin/product.products')}}</span><span class="badge badge badge-info badge-pill float-right mr-2"></span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{url('admin/products')}}" data-i18n="nav.dash.ecommerce">{{__('admin/product.allProducts')}}</a>
                    </li>
                    <li class="active"><a class="menu-item" href="{{url('/admin/products/general-information')}}" data-i18n="nav.dash.crypto">{{__('admin/product.addProduct')}}</a>
                    </li>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-cogs"></i><span class="menu-title" data-i18n="nav.templates.main">{{__('admin/sidebar.settings')}} </span></a>
                <ul class="menu-content">
