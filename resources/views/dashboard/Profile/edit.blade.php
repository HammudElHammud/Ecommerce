...
{{--    @foreach($ShippingMethod as $shipping)--}}
                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/profile.main')}} </a>
                                </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$admin->name}}" id="value"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name" >
                                                            @error("name")
                                                            <span class="text-danger">{{__('admin/profile.name required')}}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$admin->email}}" id="value"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="email" >
                                                            @error("email")
                                                            <span class="text-danger">{{__('admin/profile.email required')}}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
